    ...
    <>
      ...
      <style>
        {`
          ...
          .gooey-nav li { color: #5067EB; border: 1.5px solid; }
          .gooey-nav li.active, .gooey-nav .effect.text.active { color: #fff; border-color: transparent; }
          .gooey-nav li.active::after, .gooey-nav .effect.filter::after { background: #5067EB; }
          .dark .gooey-nav li { color: #fff; }
          .dark .gooey-nav li.active, .dark .gooey-nav .effect.text.active { color: #222; }
      ...
      <div className="relative gooey-nav" ref={containerRef}>
        ...
        >
          <ul
            ...
            style={{
              textShadow: document.body.classList.contains('dark') ? "0 1px 1px hsl(205deg 30% 10% / 0.2)" : "none",
            }}
          >
